...
*/
public class EmpDTO implements Serializable,Comparable<EmpDTO>{ //implements : 직렬화이다
	String employee_id;
	String first_name;
	String last_name;
	String email;
	...
	public EmpDTO(String employee_id, String first_name, String salary) {
		super();
	...
	public EmpDTO(String employee_id, String last_name, String email, String hire_date, String job_id) {
		super();
		this.employee_id = employee_id;
